                            ...
                            <div class="flex-grow">
                                <div class="mb-4">
                                    @if($categorie->slug === 'student')
                                        ...
                                        <svg class="h-12 w-12 text-yellow-400/50 group-hover:text-yellow-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
